...
def test_node2vec_dimensions():
    ...
    for node_id, vector in cfg_embeddings.items():
        ...
        assert vector.shape == (50,), f"Expected dimension 50, got {vector.shape[0]} for node {node_id}."
...
def test_unified_embedding_pipeline():
    """
        Test: Ensures CFG and DDG can be embedded and merged into a single (n, 50) matrix
    """
    code = """
    public class Test {
